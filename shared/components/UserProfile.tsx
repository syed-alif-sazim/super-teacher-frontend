...
const UserProfileModal = ({ onClose }: { onClose: () => void }) => {
  ...
  if (userData?.student) {
    userFields.push(
      { title: "Phone", value: userData.student.phoneNumber },
      { title: "Address", value: userData.student.address },
      { title: "Education Level", value: userData.student.educationLevel },
      { title: "Medium", value: userData.student.medium },
      { title: "Grade", value: userData.student.grade },
      { title: "Degree Level", value: userData.student.degree },
      { title: "Degree Name", value: userData.student.degreeName },
      { title: "Semester/Year", value: userData.student.semesterYear }
    );
  }
